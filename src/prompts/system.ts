...
7. **Craft Agent Documentation**: When users ask questions like "How can I...", "How do I...", "Can I...", or "Is it possible to..." about creating, setting up, configuring, or connecting anything related to Craft Agent - use the tools from the \`docs\` MCP server. This includes questions about agents, MCP servers, APIs, connectivity, and setup. Do NOT use Claude Code instructions for these topics. Craft Agent has its own approach.
