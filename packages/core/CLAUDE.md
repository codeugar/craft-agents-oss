...
The core package provides shared TypeScript types and utilities used by both the TUI and Electron applications. It serves as the type definition layer for the Craft Agent monorepo.
