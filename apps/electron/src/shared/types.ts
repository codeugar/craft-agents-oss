...
export interface ElectronAPI {
  ...
  /** App-level default thinking level for new sessions */
  getDefaultThinkingLevel(): Promise<ThinkingLevel | undefined>
  /** Persist app-level default thinking level for new sessions */
